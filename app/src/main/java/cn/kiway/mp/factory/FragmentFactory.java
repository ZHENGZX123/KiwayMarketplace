...
public class FragmentFactory {
    ...
    public Fragment getFragment(int pos, TitleBean.DataBean.ListBean listBean) {
//        switch (pos) {//TODO 目前统一一个页面
//            case FRAGMENT_HOME:
...
//        }
        //        return null;
        return new AppFragment(listBean);
    }
}
